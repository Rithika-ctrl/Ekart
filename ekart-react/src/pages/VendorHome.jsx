...
const CSS = `
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .welcome-header h1 span { color: var(--yellow); }
        .welcome-header p {
            font-size: 0.88rem; color: var(--text-dim); max-width: 420px; margin: 0 auto;
        }
        ...
        .section-label {
            ...
            color: var(--yellow); width: 100%; max-width: 860px;
        }
        ...
        .card-title {
            ...
            margin-bottom: 0.25rem; color: var(--text-white);
        }
        .card-desc {
        ...
        /* Alert badge on stock alerts card */
        .alert-badge {
 ...
 * @param {number|null} props.alertCount - Number of stock alerts
 */
export default function VendorHome({
    ...
    return (
        <>
            ...
            <title>Ekart - Vendor Dashboard</title>
            ...
            <div className="alert-stack">
                {showSuccess && (
                    <div className="alert alert-success" style={alertStyle}>
                        ...
                        <button className="alert-close" onClick={() => setShowSuccess(false)}>x</button>
                    </div>
                )}
                {showFailure && (
                    <div className="alert alert-danger" style={alertStyle}>
                        ...
                        <button className="alert-close" onClick={() => setShowFailure(false)}>x</button>
                    </div>
                )}
            </div>
            ...
            <main className="page">
                ...
                <div className="welcome-header">
                    <div className="greeting"><i className="fas fa-store"></i> Vendor Dashboard</div>
                    <h1>Welcome <span>Back!</span></h1>
                    <p>Manage your store, products, and inventory all from one place.</p>
                </div>

                <div className="section-label"><i className="fas fa-th-large"></i> Quick Actions</div>
                ...
                <div className="dashboard-grid">
                    ...
                    <a href="/stock-alerts" className="dash-card">
                        ...
                        <div className="card-icon"><i className="fas fa-bell" style={{ color: 'var(--yellow)' }}></i></div>
                        <div className="card-body-text">
