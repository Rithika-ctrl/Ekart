    ...
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .auth-header h2 { font-size: 1.5rem; font-weight: 700; letter-spacing: 0.02em; }
        .auth-header p { font-size: 0.825rem; color: var(--text-dim); margin-top: 0.5rem; }
        ...
        .form-group label {
            ...
            color: var(--text-dim); margin-bottom: 0.6rem; margin-left: 0.2rem;
        }
        ...
        .btn-submit:hover {
            ...
            box-shadow: 0 12px 32px rgba(245,168,0,0.4);
        }
      ...
      <main className="page-center">
        <div className="auth-card">
          <div className="auth-header">
            ...
            <p>Please enter your OTP and choose a strong new password.</p>
          </div>

          {sessionSuccess && (
            <div className="alert alert-success">
              <i className="fas fa-check-circle"></i> <span>{sessionSuccess}</span>
            </div>
          )}

          {sessionFailure && (
            <div className="alert alert-danger">
              <i className="fas fa-exclamation-circle"></i> <span>{sessionFailure}</span>
            </div>
          )}
      ...
      <footer>
        © 2026 <span>Ekart</span>. All rights reserved. | <i className="fas fa-heart" style={{ color: '#ff8060' }}></i> Secure Platform
      </footer>
    </>
  );
};
