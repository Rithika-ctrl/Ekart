  ...
  return (
    <>
      ...
      <style dangerouslySetInnerHTML={{ __html: `:root {
            ...
            --text-white:#ffffff; --text-light:rgba(255,255,255,0.82);
        ...
        *, *::before, *::after { margin:0; padding:0; box-sizing:border-box; }
        ...
        /* Left stripe */
        .coupon-card::before { content:''; position:absolute; left:0; top:0; bottom:0;
            width:4px; background:var(--yellow); border-radius:16px 0 0 16px; }

        .coupon-top { padding:1rem 1.1rem 0.75rem 1.3rem; }
        .coupon-code-row { display:flex; align-items:center; justify-content:space-between;
            margin-bottom:0.5rem; }
        .coupon-code { font-family:monospace; font-size:1rem; font-weight:800;
        ...
        .coupon-type-badge { font-size:0.65rem; font-weight:700; text-transform:uppercase;
        ...
        .coupon-bottom { padding:0.65rem 1.1rem 0.75rem 1.3rem;
        ...
        .coupon-meta-item { display:flex; align-items:center; gap:0.35rem;
        ...
        /* Copy button */
        .btn-copy { display:flex; align-items:center; gap:0.4rem;
        ...
        /* Expiry warning */
        .expiry-warn { font-size:0.68rem; color:#f87171;
        ...
        /* Go to cart banner */
        .cart-banner { background:rgba(245,168,0,0.08); border:1px solid rgba(245,168,0,0.2);
        ...
        .btn-go-cart { display:flex; align-items:center; gap:0.45rem;
