...
export default function DeliveryOtp({
    ...
    const CSS = `:root{--yellow:#f5a800;--yellow-d:#d48f00;--glass-border:rgba(255,255,255,0.22);--glass-card:rgba(255,255,255,0.13);--glass-nav:rgba(0,0,0,0.25);--text-white:#ffffff;--text-light:rgba(255,255,255,0.80);--text-dim:rgba(255,255,255,0.50);}
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        @media(max-width:500px){nav{padding:0.875rem 1.25rem;}.form-card{padding:1.75rem 1.25rem;}.otp-box{width:42px;height:52px;font-size:1.2rem;}}`;
    ...
    return (
        <div className="otp-verification-container">
            ...
            {/* ── NAV ── */}
            <nav id="nav">
                <Link to="/delivery/login" className="nav-brand">
            ...
            <main className="page">
                <div className="form-card">
                    ...
                    <Link to="/delivery/login" className="back-link">
                        <i className="fas fa-arrow-left"></i> Back to Login
                    </Link>
                </div>
            </main>
