...
export default function DeliveryHome({
    ...
    const CSS = `
        ...
        .delivery-body { font-family: 'Poppins', sans-serif; min-height: 100vh; color: var(--text-white); display: flex; flex-direction: column; position: relative; }
        ...
        .btn-change-wh { display: flex; align-items: center; gap: 0.4rem; background: rgba(99,179,237,0.12); border: 1px solid rgba(99,179,237,0.35); color: #63b3ed; border-radius: 8px; padding: 0.45rem 1rem; font-size: 0.78rem; font-weight: 600; cursor: pointer; transition: all 0.2s; }
        ...
        .count-badge { background: var(--yellow); color: #1a1000; font-size: 0.68rem; font-weight: 700; padding: 0.2rem 0.6rem; border-radius: 20px; }
        .order-card { background: rgba(255,255,255,0.05); border: 1px solid rgba(255,255,255,0.1); border-radius: 12px; padding: 1rem 1.1rem; margin-bottom: 0.75rem; }
        .order-id { font-weight: 700; color: var(--yellow); font-size: 0.9rem; }
        .btn-pickup { background: var(--yellow); color: #1a1000; border: none; border-radius: 8px; padding: 0.5rem 1rem; font-size: 0.78rem; font-weight: 700; cursor: pointer; }
        .otp-input { width: 100%; background: rgba(255,255,255,0.06); border: 1px solid rgba(255,255,255,0.2); border-radius: 8px; padding: 0.5rem; color: white; text-align: center; font-size: 1rem; letter-spacing: 0.2em; }
        .toast { position: fixed; bottom: 2rem; right: 2rem; z-index: 9999; background: rgba(10,12,30,0.95); backdrop-filter: blur(16px); border: 1px solid; border-radius: 12px; padding: 1rem 1.25rem; min-width: 240px; display: flex; align-items: center; gap: 0.6rem; }
        .toast.success { border-color: rgba(34,197,94,0.5); color: #22c55e; }
        .toast.error { border-color: rgba(255,100,80,0.5); color: #ff8060; }
        .modal-overlay { position: fixed; inset: 0; z-index: 500; background: rgba(0,0,0,0.65); backdrop-filter: blur(6px); display: flex; align-items: center; justify-content: center; }
        .modal-box { background: rgba(12,16,36,0.97); border: 1px solid var(--glass-border); border-radius: 20px; padding: 2rem; width: 100%; max-width: 480px; }
        ...
        @media(max-width:900px){ .col-grid, .stats-row { grid-template-columns: 1fr; } }
    `;
    ...
    return (
        <div className="delivery-body">
            ...
            <nav>
                <a className="nav-brand" href="/delivery/home">
                ...
                <div className="nav-right">
                    ...
                    <a href="/delivery/logout" className="btn-logout"><i className="fas fa-sign-out-alt"></i> Logout</a>
                </div>
            </nav>
