...
export default function DeliveryRegister({
    ...
    const CSS = `:root{--yellow:#f5a800;--yellow-d:#d48f00;--glass-border:rgba(255,255,255,0.22);--glass-card:rgba(255,255,255,0.13);--glass-nav:rgba(0,0,0,0.25);--text-white:#ffffff;--text-light:rgba(255,255,255,0.80);--text-dim:rgba(255,255,255,0.50);}
        *,*::before,*::after{margin:0;padding:0;box-sizing:border-box;}
        ...
        .form-card{background:var(--glass-card);backdrop-filter:blur(20px);border:1px solid var(--glass-border);border-radius:20px;padding:2.5rem;width:100%;max-width:500px;box-shadow:0 40px 100px rgba(0,0,0,0.4);animation:fadeUp 0.5s ease both;}
        ...
        .btn-submit{width:100%;background:var(--yellow);color:#1a1000;border:none;border-radius:12px;padding:0.95rem;font-family:'Poppins',sans-serif;font-size:0.9rem;font-weight:700;letter-spacing:0.06em;text-transform:uppercase;cursor:pointer;transition:all 0.3s;box-shadow:0 8px 24px rgba(245,168,0,0.25);display:flex;align-items:center;justify-content:center;gap:0.5rem;margin-top:1.25rem;}
        ...
        @media(max-width:540px){.form-row{grid-template-columns:1fr;}.form-card{padding:1.75rem 1.25rem;}nav{padding:0.875rem 1.25rem;}}`;
    ...
    return (
        <div className="delivery-register-container">
            ...
            <nav id="nav">
                ...
                <Link to="/delivery/login" className="nav-link-btn">
