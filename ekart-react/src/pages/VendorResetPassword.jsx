...
const CSS = `
        ...
        *, *::before, *::after { margin: 0; padding: 0; box-sizing: border-box; }
        ...
        .page-header {
            ...
            padding: 2rem 2.5rem;
            display: flex; align-items: center; justify-content: space-between;
            gap: 1.5rem; width: 100%; max-width: 500px;
        ...
        .otp-banner i { color: var(--yellow); font-size: 1rem; flex-shrink: 0; margin-top: 0.1rem; }
 ...
 * @param {string|null} props.id - Hidden user/request ID
...
export default function VendorResetPassword({
    ...
    const matchLabel = confirmPassword
    ...
    return (
        <>
            ...
            <title>Ekart - Reset Password</title>
            <link rel="icon" type="image/svg+xml" href="data:image/svg+xml,%3Csvg xmlns='http://www.w3.org/2000/svg' viewBox='0 0 576 512'%3E%3Cpath fill='%23f5a800' d='M528.12 301.319l47.273-208C578.806 78.301 567.391 64 551.99 64H159.208l-9.166-44.81C147.758 8.021 137.93 0 126.529 0H24C10.745 0 0 10.745 0 24v16c0 13.255 10.745 24 24 24h69.883l70.248 343.435C147.325 417.1 136 435.222 136 456c0 30.928 25.072 56 56 56s56-25.072 56-56c0-22.172-12.888-41.332-31.579-50.405l5.517-24.276c3.413-15.018-8.002-29.319-23.403-29.319H218.117l-6.545-32h293.145c11.206 0 20.92-7.754 23.403-18.681z'/%3E%3C/svg%3E" />
            ...
            <main className="page">
                ...
                <div className="form-card">
                    <form action="/vendor/reset-password" method="post">
                        <input type="hidden" name="id" value={id} />
                        {csrfToken && <input type="hidden" name="_csrf" value={csrfToken} />}

                        {/* Section: Verification */}
                        <div className="section-label"><i className="fas fa-shield-alt"></i> Verification</div>

                        {/* OTP info banner */}
                        <div className="otp-banner">
                            <i className="fas fa-envelope-open-text"></i>
                            <span>A one-time password (OTP) has been sent to your registered email address. Please check your inbox and enter it below.</span>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <input type="number" id="otp" name="otp" className="form-control otp-input"
                                       placeholder="• • • • • •" required />
                            </div>
                        </div>

                        {/* Section: New Password */}
                        <div className="section-label" style={{ marginTop: '2rem' }}><i className="fas fa-lock"></i> New Password</div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <i className={`fas ${showPassword ? 'fa-eye-slash' : 'fa-eye'} toggle-pw`} onClick={() => setShowPassword(!showPassword)}></i>
                            </div>
                            {/* Strength bar */}
                            <div className="strength-bar-wrap">
                                <div className="strength-bar" id="strengthBar" style={{ width: `${strength}%`, background: strengthColor }}></div>
                            </div>
                            <div className="strength-label" id="strengthLabel" style={{ color: textColor }}>{strengthText}</div>
                        </div>
                        ...
                        <div className="form-group">
                            ...
                            <div className="input-wrapper">
                                ...
                                <i className={`fas ${showConfirmPassword ? 'fa-eye-slash' : 'fa-eye'} toggle-pw`} onClick={() => setShowConfirmPassword(!showConfirmPassword)}></i>
                            </div>
                            <span className="strength-label" id="matchLabel" style={{ color: matchLabel.color }}>{matchLabel.text}</span>
                        </div>
