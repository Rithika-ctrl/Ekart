...
export default function VendorForgotPassword({
    ...
    return (
        <>
            ...
            <title>Ekart - Forgot Password</title>
            ...
            <main className="page">
                <div className="form-card">
                    <div className="card-top">
                        <div className="card-icon"><i className="fas fa-key" style={{ color: 'var(--yellow)' }}></i></div>
                        <h1>Forgot <span>Password?</span></h1>
                        <p>Enter your email and we'll send you an OTP to reset your password.</p>
                    </div>

                    <div className="section-label"><i className="fas fa-envelope"></i> Account Email</div>

                    <form action="/vendor/forgot-password" method="post">
