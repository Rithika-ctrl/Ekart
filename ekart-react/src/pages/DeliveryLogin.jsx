...
export default function DeliveryLogin({
    ...
    const CSS = `
        ...
        .divider {
            ...
            margin: 1.25rem 0; color: var(--text-dim); font-size: 0.75rem;
        }
        .divider::before, .divider::after { content: ''; flex: 1; height: 1px; background: var(--glass-border); }

        .btn-register {
            width: 100%; background: transparent; color: var(--yellow);
            border: 1px solid rgba(245,168,0,0.4); border-radius: 12px;
            padding: 0.8rem; font-family: 'Poppins', sans-serif;
