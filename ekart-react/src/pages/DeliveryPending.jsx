...
export default function DeliveryPending() {
    const CSS = `
        ...
        .card {
            ...
            border-radius: 20px; padding: 3rem 2.5rem; width: 100%; max-width: 500px;
            text-align: center; box-shadow: 0 40px 100px rgba(0,0,0,0.4); animation: fadeUp 0.5s ease both;
        }

        .pending-icon {
            width: 88px; height: 88px; background: rgba(245,168,0,0.12); border: 2px solid rgba(245,168,0,0.3);
            border-radius: 50%; display: flex; align-items: center; justify-content: center;
            font-size: 2.5rem; margin: 0 auto 1.5rem; animation: pulse 2.5s ease-in-out infinite;
        }

        @keyframes pulse {
            0%, 100% { box-shadow: 0 0 0 0 rgba(245,168,0,0.25); }
            50% { box-shadow: 0 0 0 16px rgba(245,168,0,0); }
        }
        ...
        .step-dot {
            ...
            justify-content: center; font-size: 0.8rem; font-weight: 700; flex-shrink: 0; border: 2px solid;
        }
        ...
        .btn-check {
            display: inline-flex; align-items: center; gap: 0.5rem; background: rgba(245,168,0,0.15);
            border: 1px solid rgba(245,168,0,0.35); color: var(--yellow); text-decoration: none;
            font-size: 0.85rem; font-weight: 600; padding: 0.75rem 1.5rem; border-radius: 10px;
        ...
        <div className="delivery-pending-container">
            ...
            <main className="page">
                <div className="card">
                    ...
                    <a href="/delivery/login" className="btn-check">
