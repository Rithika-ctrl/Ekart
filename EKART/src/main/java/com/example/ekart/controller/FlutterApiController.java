...
public class FlutterApiController {
     ...
     *   2. Persists the new password to the .env file (ADMIN_PASSWORD=...) so
     ...
     * Reads the file line-by-line, replaces the ADMIN_PASSWORD= line, and
    ...
    private void persistPasswordToEnv(String newPassword) throws java.io.IOException {
        ...
        String newLine = "ADMIN_PASSWORD=" + newPassword;
