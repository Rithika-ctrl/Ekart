...
rows += [
    ...
    (206, "Admin Password Change via API", "POST /api/react/admin/change-password — validates currentPassword, updates in-memory adminPassword field AND writes to .env file (ADMIN_PASSWORD=...) atomically via temp file rename", "ReactApiController.adminChangePassword()", "Controller", "Yes"),
